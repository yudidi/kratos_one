...
var file_api_server_server_proto_rawDesc = string([]byte{
...
var (
	...
	file_api_server_server_proto_rawDescData []byte
)

func file_api_server_server_proto_rawDescGZIP() []byte {
	file_api_server_server_proto_rawDescOnce.Do(func() {
		file_api_server_server_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_api_server_server_proto_rawDesc), len(file_api_server_server_proto_rawDesc)))
	})
	return file_api_server_server_proto_rawDescData
}

var file_api_server_server_proto_msgTypes = make([]protoimpl.MessageInfo, 10)
var file_api_server_server_proto_goTypes = []any{
...
func file_api_server_server_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_api_server_server_proto_rawDesc), len(file_api_server_server_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   10,
			NumExtensions: 0,
			NumServices:   1,
